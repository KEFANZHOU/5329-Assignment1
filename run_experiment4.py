...
def _experiment4_summary_extra(
    condition_name: str,
...
def run_experiment4(
    output_root: str = "exp_outputs/experiment4_activation",
    num_steps: int = 30000,
    checkpoint: int = 200,
    batch_size: int = 8,
    seed: int = 42,
    ...
    experiment_spec = {
        "title": "Experiment 4: Effect of Activation Function",
        "research_question": (
...
def plot_experiment4_results(
    ...
    print(f"Saved experiment 4 plots to {output_root}")
